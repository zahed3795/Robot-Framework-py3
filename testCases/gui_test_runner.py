...
class App:
    ...
    def __init__(self, master):
        ...
        self.title = Label(
            frame, text="www.guildmortgage.com", fg="green").pack()
        self.title1 = Label(
            frame, text="Run a Test in Chrome:", fg="blue").pack()
        self.run1 = Button(
            frame, command=self.run_1, text="Running all robot test", fg="green").pack()
        self.end_title = Label(
            frame, text="", fg="pink").pack()
        self.quit = Button(
            frame, text="QUIT!!", fg="blue", command=frame.quit).pack()
